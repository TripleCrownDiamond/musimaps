-- ============================================================
-- 00018 — Ajouter OU mettre à jour un artiste découvert
-- La table map_artists est en lecture/insertion publique mais sa
-- mise à jour est réservée à l'admin et au propriétaire (RLS).
-- Ce RPC (SECURITY DEFINER) permet au site public de compléter le
-- profil d'un artiste déjà présent (bio, plateformes, réseaux)
-- sans jamais toucher aux champs de modération (verified,
-- claimed_by). Niveau de confiance équivalent à l'insertion
-- publique déjà ouverte (map_artists_insert_public).
-- ============================================================
